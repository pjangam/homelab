...
# scripts/notify/setup_ntfy_users.sh). If it is unset the call is a silent no-op, so
...
#
# Companion to scripts/notify/send_email.sh; callers generally send both, since email
