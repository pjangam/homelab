...
#   ./scripts/pi-buttons/diagnose_white_noise_buttons.sh          # status only
#   ./scripts/pi-buttons/diagnose_white_noise_buttons.sh --inject # also publish a synthetic PRESS and watch the switch
set -u
PI=192.168.1.124
