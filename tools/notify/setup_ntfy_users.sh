...
#   homelab-health  - healthcheck.sh / watchdog alerts (scripts/notify/push_ntfy.sh)
...
umask 077
cat > "$ENVFILE" <<ENVEOF
# ntfy credentials - generated by scripts/notify/setup_ntfy_users.sh. Gitignored.
...
# NTFY_HEALTH_TOKEN    : write-only publish token used by scripts/notify/push_ntfy.sh
