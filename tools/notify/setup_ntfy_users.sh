...
#   homelab-health  - healthcheck.sh / watchdog alerts (tools/notify/push_ntfy.sh)
...
umask 077
cat > "$ENVFILE" <<ENVEOF
# ntfy credentials - generated by tools/notify/setup_ntfy_users.sh. Gitignored.
...
# NTFY_HEALTH_TOKEN    : write-only publish token used by tools/notify/push_ntfy.sh
